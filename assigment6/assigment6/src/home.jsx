...
function Home() {
  ...
  useEffect(() => {
     if (!search) return; // Only search if there's a query
            ...
            <div className='imgContainer'>
                ...
                <div className='displayMovie' key={movie.id}>
                    ...
                    <div className='textholder'>
                      ...
                      <div className='movieDescription'><p>{movie.overview}
                      From {movie.release_date ? movie.release_date.slice(0,4) : 'N/A'}</p></div>
                    </div>
                </div>
                 ))}
            </div>
