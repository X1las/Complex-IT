...
public class Request { public string? Method, Path, Date, Body; } // simple DTO for incoming request fields
public class Response { public string Status = ""; } // simple DTO for validator response status
...
// public record Client(bool Connected);
// public class ConnectionTests {
//     Client Connect() => new(true);
...
public static class Program
{
    public static void Main(string[] args)
    {
        ...
        Server.ServerProgram.StartServer(5000);
